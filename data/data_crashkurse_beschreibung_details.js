export const crashkurse_beschreibung_details = [
  {
    ...
    link_pdf: [
      ...
      "/doc/Anmeldung_zum_Crashkurs_Agile_Coach.pdf",
      "/doc/Prospekt_Crashkurs_Agile_Coach.pdf",
    ],
    link_boton: "",
    texto_leistungen: [
    ...
    texto_inhalte: [
      ...
      },
      {
        ...
        text: [
          ...
          "Werte, Prinzipien & Regeln, Scrum Rollen (PO, SM, Entwicklungs-Team)",
  ...
  },
  {
    ...
    link_boton: "",
    texto_leistungen: [
      "2 Tage Crashkurs remote oder vor Ort möglich (Mi. / Do.)",
      "Methodenkoffer für die agile Zusammenarbeit",
      "Das Buch “Crashkurs Selbstorganisation in Agilen Teams”",
      "Fotoprotokoll & Screenshots",
    ],
  ...
  },
  {
    ...
    texto_vorteile: [
      "33 kurze Video-Clips Teilnahme weltweit möglichMit konkreten Beispielen aus der " +
    ...
    link_termine: "",
    link_pdf: [
      "/doc/Onepager_Crashkurs_Selbstorganisation_in_agilen_Teams.pdf",
    ],
    link_boton:
      "https://open-agile-academy.teachable.com/p/online-crashkurs-selbstorganisation-i" +
      "n-agilen-teams",
    texto_leistungen: [
      "12 Video-Clips zur Architektur selbstorganisierter Teams",
      "21 Video-Clips mit verschiedenen Workhacks für die konkrete Selbstorganisation",
      "Online-Zugang zum Crashkurs Selbstorganisation in agilen Teams",
      "2 Stunden Supervision mit einem unserer Agile Coaches (vor dem Crashkurs und dan" +
        "ach)",
    ],
