export const crashkurse_beschreibung_details = [
    {
        ...
        "texto_beschreibung": ["Agile Coach unterstützt Du einzelne Menschen, Teams und Organisationen auf ihrem" +
                " Weg zu einer stimmigeren Arbeitswelt. Für Deine Klienten besteht oftmals der Wu" +
                "nsch sich agiler an eine sich immer schneller verändernde Umwelt anzupassen zu k" +
                "önnen. Für diese und viele weitere Fragestellungen gehst Du ziel- und lösungsori" +
                "entiert vor und nutzt dafür einen breiten Werkzeugkoffer an Coaching-Modellen un" +
                "d agilen Methoden."],
        "texto_vorteile": [
            "In unserem 8-tägigen Crashkurs zum Agile Coach lernst Du schnell und einfach das" +
                    " Wichtigste, um Organisationen, Teams und Individuen im Sinne des agilen Manifes" +
        ...
        "texto_inhalte": [
            {
                ...
                "title": "Block 3",
                "text": [
                    "Entscheidungen & Konflikte: Initiatoren von innovativen Ideen stärken und beglei" +
                            "ten im agilen Kontext",
        ...
        "texto_inhalte_old": [
            "Block 1: Tätigkeitsfeld eines agilen Coaches. Werte und Prinzipien im agilen Kon" +
                    "text. Mindset (Ich) und Haltung (Du). ",
            "Block 2: Architektur agiler Netzwerkorganisationen. Agile Methoden und Prozesse." +
                    " Bewährte agile Coaching-Modelle.",
            "Block 3: Entscheidungen & Konflikte: Initiatoren von innovativen Ideen stärken u" +
                    "nd begleiten im agilen Kontext. Agile Projektarbeit: Entwicklung und Moderation " +
                    "von agilen Workshops. Bewährte agile Coaching-Modelle.",
            "Block 4: Remote Work: Fallstricke und geeignete Lösungen in der Zusammenarbeit. " +
                    "Selbstorganisation mit Workhacks. Bewährte agile Coaching-Modelle"
        ],
        ...
        "image2": "crashkurse/notes.jpg",
        "image_vorteile": "crashkurse/image3.jpg",
        "texto_beschreibung": ["Als Agile Facilitator begleitest Du Dein Team in die agile Arbeitswelt. Zudem bi" +
                "st Du als Vorbild für eine lösungsorientierte- und zielgerichtete Zusammenarbeit" +
                " der erste Kontakt, wenn es darum geht innovative Ideen von Anfang an zu begleit" +
                "en. Daraus resultierende Meetings & Workshops moderierst Du immer mit Blick auf " +
                "die agilen Werte & Prinzipien. Bei Herausforderungen greifst Du auf Deinen breit" +
                "en Werkzeugkoffer an agilen Methoden & Workhacks zurück."],
        "texto_vorteile": [
            "In unserem 2-tägigen Crashkurs zum Agile Facilitator lernst Du schnell und einfa" +
                    "ch das Wichtigste, um Eure Zusammenarbeit im Team kontinuierlich, lernend und mi" +
                    "t Spaß zu verbessern.",
            "Mit unserem hybriden Konzept kannst Du von überall auf der Welt an dem Crashkurs" +
                    " teilnehmen. Selbstverständlich aber auch in Präsenz vor Ort, in unserer schönen" +
                    " Hansestadt Bremen.",
            "Mit konkreten Beispielen aus der Beratungs- Praxis geben wir Dir einen tiefen, a" +
        ...
        "image_inhalte": "crashkurse/image4.jpg",
        "image2": "crashkurse/notes.jpg",
        "texto_beschreibung": ["Als Scrum Master arbeitest Du nach den Werten, Prinzipien und Regeln des Agilen " +
                "Manifests und des Scrum Guides.  Zusammen mit dem Product Owner und dem Entwickl" +
                "ungsteam bist Du Teil eines cross-funktionalen und selbstorganisierten Scrum-Tea" +
                "ms. Schwerpunkt Deiner Tätigkeit ist die prozessuale und laterale Führung des Te" +
                "ams durch den Scrum-Prozess."],
        "texto_vorteile": [
            "In unserem 2-tägigen Crashkurs zum Scrum Master lernst Du schnell und einfach da" +
                    "s Wichtigste, um im Anschluss die Prüfung zum Professional Scrum Master auf scru" +
                    "m.org durchzuführen.",
            "Mit unserem hybriden Konzept kannst Du von überall auf der Welt an dem Crashkurs" +
                    " teilnehmen. Selbstverständlich aber auch in Präsenz vor Ort, in unserer schönen" +
                    " Hansestadt Bremen.",
            "Mit konkreten Beispielen aus der Praxis geben wir Dir einen tiefen, aber dennoch" +
                    " verständlichen Einblick in die agile Arbeitswelt."
        ],
        "texto_inhalte": [
            {
