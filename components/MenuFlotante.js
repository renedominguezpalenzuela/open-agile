...
export default function MenuFlotante() {
  return (
    <>
       <div className="sidepanel-new offcanvas offcanvas-end  " tabIndex="-1" id="mySidepanel">
        <div className="row mt-3 mb-3 d-flex justify-content-end align-items-center">
          ...
          <div className="col-2 d-flex justify-content-end ms-2  ">         
            <div id="boton_cerrar_menu" className="me-3 font-title-side-menu boton_cerrar_menu_lateral" data-bs-dismiss="offcanvas">
              X
            </div>
          </div>
        </div>
        ...
        <div className="row  ">
          <ul
            ...
            <li className="nav-item" >
              <a href="/#course" className="nav-link text-truncate" id="crashkurse_link"  data-bs-dismiss="offcanvas-end" >
