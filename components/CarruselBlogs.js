                ...
                <div key={index} className={`${index === 0 ? "active" : ""} carousel-item `}>
                  <div className="row w-100 ">
                    ...
                    <div className="col-4">
                      ...
                      <Card05UserBlog data={lista_cards[index + 1]} />
                    </div>
                    <div className="col-4">
                      ...
                      <Card05UserBlog data={lista_cards[index + 2]} />
                    </div>
                  </div>
                </div>
              ) : null
            ...
            <div key={lista_cards.length - 2} className="carousel-item">
              <div className="row w-100 ">
                <div className="col-4">
                  ...
                  <Card05UserBlog data={lista_cards[lista_cards.length - 2]} />
                </div>
                <div className="col-4">
                ...
                <div className="col-4">
                  ...
                  <Card05UserBlog data={lista_cards[0]} />
                </div>
              </div>
            </div>
            ...
            <div key={lista_cards.length - 1} className="carousel-item">
              <div className="row w-100 ">
                <div className="col-4">
                  ...
                  <Card05UserBlog data={lista_cards[lista_cards.length - 1]} />
                </div>
                <div className="col-4">
                  {/* <Card05UserBlog id={lista_cards[0].id} imagen={lista_cards[0].image} titulo={lista_cards[0].title} titulo2={lista_cards[0].titulo2} link={lista_cards[0].link} /> */}
                  <Card05UserBlog data={lista_cards[0]} />
                ...
                <div className="col-4">
                  ...
                  <Card05UserBlog data={lista_cards[1]} />
                </div>
              </div>
            </div>
          </div>
