...
<>
  ...
  <div id="empresas" className="color_fondo div_content03b pt-5">
    ...
    <div className="row mt-5 mb-5 pb-5 d-flex justify-content-center align-items-center      ">
      ...
      <div className="row mt-5 mb-5 pb-5 d-flex align-items-end justify-content-center   ">
      <div className="col-3 m-3 ">
        <a href="https://www.sparkasse-bremen.de/de/home.html" aria-pressed="true">
          <img className="img-fluid img-sponsors5 grayscale" src="/img/sponsors/logo-bremen.png" />
        </a>
      </div>
      <div className="col-3 m-3">
        <a href="https://www.soprasteria.com/ " aria-pressed="true">
          <img className="img-fluid img-sponsors6 grayscale" src="/img/sponsors/logo-soprasteria.png" />
        </a>
      </div>
