          ...
          <div className=" m-5 w-75 position-celda-imagen-left ">
            <div className="contenedor_tabla  ">
              <div className="mask_right pe-4  d-flex   justify-content-end">
               <img className="image-tabla  sombra_right" src={`https://storage.googleapis.com/jsopenagile/img/${img}`} alt="" loading="lazy"  />
              </div>
          ...
          <div className=" m-5 w-75 position-celda-imagen-right pb-5 ">
            <div className="contenedor_tabla ">
              <div className="mask_left  d-flex   justify-content-start">
               <img className="image-tabla sombra_left" src={`https://storage.googleapis.com/jsopenagile/img/${img}`} alt="" loading="lazy" />
          ...
          <div className=" mt-5 w-100  ">
            {/* <div className="contenedor_tabla "> */}
              ...
              <div className=" ps-4 pe-4 pb-3  d-flex   justify-content-center">
               <img className="image-tabla-estrecho  sombra_right" src={`https://storage.googleapis.com/jsopenagile/img/${img}`} alt="" loading="lazy"  />
              </div>
